...
<?php if(is_array($content)): $i = 0; $__LIST__ = $content;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><div class="container-fluid blog-container">
	    <div class="row">
			<div class="col-md-9 blog-container-list">
				<div class="page-header">
					<h2><a href="/thelastbattel/index.php/Home/Index/articleshow/?page=<?php echo ($list["id"]); ?>"><?php echo ($list["kind"]); ?></a></h2>
				</div>
				<div class="panel">
					<div class="panel-body"><?php echo ($list["content"]); ?></div>
					<div class="panel-footer">
						创建于：<?php echo ($list["time"]); ?>		By <?php echo ($list["user_name"]); ?>
					</div>
				</div>
				</div>
		</div>
...
<script type="text/javascript" src="/thelastbattel/Public/js/blog.js"></script>
