		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="/thelastbattel/index.php/Home/Index/checkremark">评论</a></li>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" 
   ...
   <form class="form-horizontal" role="form"method="post" action="/thelastbattel/index.php/Home/Index/edit" name="edit" id ="edit" target="_top">
   <div class="form-group">
      ...
      <div class="col-sm-offset-2 col-sm-10">
         <button type="submit" id = "div1"class="btn btn-default">更改</button>
      </div>
   </div>
</form>
...
<div class="page-header"><h4>留下足迹</h4><a name="comment"></a></div>
    ...
    <div class="nickname">
		    	...
		    	<?php echo ($remark["remark_time"]); ?> <?php echo ($remark["remark_user"]); ?>  </div>
    <div class="message"><?php echo ($remark["remark_content"]); ?></div>
	<div class="clear">
		<ul class="list-group">
